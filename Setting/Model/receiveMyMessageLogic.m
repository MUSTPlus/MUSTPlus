...
@implementation receiveMyMessageLogic

//拿数据
+(NSMutableArray *) getDataFromCoreData{
    MyMessageCoreDataManagement *dataManagement = [[MyMessageCoreDataManagement alloc] init];
    
    NSMutableArray *mainBodyArray = [[NSMutableArray alloc] init];
    
    NSMutableArray<MyMessageCircle_main *> *mainArray = [[NSMutableArray alloc] init];
    mainArray = [dataManagement selectData:0 andOffset:0];
    
    for (MyMessageCircle_main *main in mainArray){
        ...
        //加评论
        for(MyMessageCircle_comments *comment in main.relationship){
...
+(NSMutableArray *) pullDownToRefresh:(NSMutableArray *)oldNews
    ...
    MyMessageCoreDataManagement *magege =  [[MyMessageCoreDataManagement alloc] init];
          ...
          Comment:(NSMutableDictionary *)String
{
    NSString *IDstr  = [NSString stringWithFormat:@"%lld",ID];
    MyMessageCoreDataManagement *magege =  [[MyMessageCoreDataManagement alloc] init];
    [magege updateComment:IDstr withComment:String];
}
