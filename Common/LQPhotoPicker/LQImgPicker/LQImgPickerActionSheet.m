...
- (void)showImgPickerActionSheetInView:(UIViewController*)controller{
    ...
    [alertVC addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"取消", "") style:UIAlertActionStyleCancel handler:nil]];
//    [alertVC addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"拍照", "")  style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
//            NSLog(@"2");
//        } else {
//            [CirnoError ShowErrorWithText:@"请打开相机权限" ];
//        }
//        
//    }]];

    [alertVC addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"从相册选择", "") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleDefault];
