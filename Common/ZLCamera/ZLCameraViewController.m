...
@interface ZLCameraViewController () <UIActionSheetDelegate,UICollectionViewDataSource,UICollectionViewDelegate,AVCaptureMetadataOutputObjectsDelegate,LGCameraImageViewDelegate,ZLCameraImageViewDelegate,ZLCameraViewDelegate>
...
- (void) setup{
    ...
    deviceBtn = [self setupButtonWithImageName:@"xiang" andX:self.view.width - margin - width];
...
//    flashBtn = [self setupButtonWithImageName:@"" andX:10];
