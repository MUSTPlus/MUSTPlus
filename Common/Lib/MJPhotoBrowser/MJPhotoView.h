...
@interface MJPhotoView : UIScrollView <UIScrollViewDelegate,LongClickDelegate>
// 图片
@property (nonatomic, strong) MJPhoto *photo;
// 代理
@property (nonatomic, weak) id<MJPhotoViewDelegate> photoViewDelegate;
@property (nonatomic,weak) id<LongClickDelegate>ClickDelegate;
@end
